...
// The Topics queue is gone: the Chapters queue now generates topics and
// concepts in the same job, so a separate topic step could only ever disagree
// with it. topic_master is still filled, and the topics are still shown --
// grouped above their concepts in the Concepts queue, where they matter.
