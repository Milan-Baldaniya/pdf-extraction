                  ...
                  >
                    <Tabs defaultValue="knowledge" className="w-full mt-2">
                      <TabsList className="mb-6 bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl p-1 inline-flex w-full overflow-x-auto justify-start h-auto flex-wrap gap-1">
                        <TabsTrigger value="knowledge" className="rounded-lg px-3 py-1.5 text-xs">Knowledge</TabsTrigger>
                        <TabsTrigger value="pedagogy" className="rounded-lg px-3 py-1.5 text-xs">Pedagogy</TabsTrigger>
                        <TabsTrigger value="misconception" className="rounded-lg px-3 py-1.5 text-xs">Misconceptions</TabsTrigger>
                        <TabsTrigger value="realworld" className="rounded-lg px-3 py-1.5 text-xs">Real World</TabsTrigger>
                        <TabsTrigger value="activities" className="rounded-lg px-3 py-1.5 text-xs">Activities</TabsTrigger>
                        <TabsTrigger value="outcomes" className="rounded-lg px-3 py-1.5 text-xs">Outcomes</TabsTrigger>
                      </TabsList>
                      ...
                      <TabsContent value="misconception" className="space-y-4">
                ...
                {topicsList[activeTopic].concepts && topicsList[activeTopic].concepts.map((conceptObj: any, cIdx: number) => (
                  ...
                  >
                    <Tabs defaultValue="knowledge" className="w-full mt-2">
                      <TabsList className="mb-6 bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-xl p-1 inline-flex w-full overflow-x-auto justify-start h-auto flex-wrap gap-1">
                        <TabsTrigger value="knowledge" className="rounded-lg px-3 py-1.5 text-xs">Knowledge</TabsTrigger>
                        <TabsTrigger value="ability" className="rounded-lg px-3 py-1.5 text-xs">Ability</TabsTrigger>
                        <TabsTrigger value="skill" className="rounded-lg px-3 py-1.5 text-xs">Skill</TabsTrigger>
                        <TabsTrigger value="competency" className="rounded-lg px-3 py-1.5 text-xs">Competency</TabsTrigger>
                        <TabsTrigger value="blooms" className="rounded-lg px-3 py-1.5 text-xs">Bloom's</TabsTrigger>
                        <TabsTrigger value="dok" className="rounded-lg px-3 py-1.5 text-xs">DOK</TabsTrigger>
                        <TabsTrigger value="prerequisite" className="rounded-lg px-3 py-1.5 text-xs">Prerequisites</TabsTrigger>
                        <TabsTrigger value="misconception" className="rounded-lg px-3 py-1.5 text-xs">Misconceptions</TabsTrigger>
                        <TabsTrigger value="realworld" className="rounded-lg px-3 py-1.5 text-xs">Real World</TabsTrigger>
                        <TabsTrigger value="pedagogy" className="rounded-lg px-3 py-1.5 text-xs">Pedagogy</TabsTrigger>
                        <TabsTrigger value="objectives" className="rounded-lg px-3 py-1.5 text-xs">Objectives</TabsTrigger>
                        <TabsTrigger value="outcomes" className="rounded-lg px-3 py-1.5 text-xs">Outcomes</TabsTrigger>
                        <TabsTrigger value="blueprint" className="rounded-lg px-3 py-1.5 text-xs">Blueprint</TabsTrigger>
                      </TabsList>
